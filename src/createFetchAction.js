...
const createFetchAction = ({
  ...
  return Promise.resolve()
    ...
    .then((response) => {
      ...
      invariant(
        typeof json.then === 'function',
        '@@fetch-actions/createFetchAction responseHandler must always return a valid response with a json method that returns a promise'
      )
      return json
    })
